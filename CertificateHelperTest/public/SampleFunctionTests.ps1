...
function CertificateHelperTest_GetPublicString{ 
...
function CertificateHelperTest_GetPrivateString {

    $testedModulePath =  $TESTED_MODULE_PATH | Join-Path -ChildPath "CertificateHelper.psd1"
...
Export-ModuleMember -Function CertificateHelperTest_*
